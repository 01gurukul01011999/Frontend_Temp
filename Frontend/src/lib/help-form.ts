  ...
  returns: {
    ...
    items: [
      { label: 'I have received wrong return', form_id: 'form_returns_0',
        description:
          "If you have received a damaged product as a return, you can claim the dispute within 7 days of return delivery. Please raise a ticket attaching images of the reverse waybill, <b>Packet ID</b>, returned product along with unpacking video. <b>Packet ID has to be mandatorily entered (wherever available) while raising claims and clearly shown in the unboxing video.</b>",
...
// intentionally export only the named helpMap
