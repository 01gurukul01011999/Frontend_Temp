...
const formsJson = {
  "form_101": {
    ...
    "ProductDetails": [
      ...
      { "label": "Net Quantity (N)", "type": "text", "placeholder": "Enter Quantity" },
      ...
      { "label": "Warranty", "type": "dropdown", "options": ["Above 2 Years"] },
    ...
    "AddProductDetails": {
      ...
      "ProductSizeInventory": [
        ...
        { "label": "Size", "type": "dropdown", "options": ['Free Size', 'S', 'M', 'L'] }
      ]
    }
  }
};
