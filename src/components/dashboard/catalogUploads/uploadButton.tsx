   ...
   <Box sx={{ p: 3, backgroundColor: '#ffff', mr: -3, ml: -3 , mt: 1, mb: 1 }}>
      ...
      <Stack direction="row" spacing={2} mb={1}>
        ...
        <Button
          ...
          onClick={() => { window.location.href = '/dashboard/catalog-uploads/Bulk-Catalog-Upload'; }}
        >
          Add Catalog in Bulk
        </Button>
        <Button variant="outlined" sx={{ color: '#4d0aff', borderColor: '#4d0aff' }}
        onClick={() => { window.location.href = '/dashboard/catalog-uploads/Single-Catalog-Upload'; }}
        >
          Add Single Catalog
        </Button>
      </Stack>
