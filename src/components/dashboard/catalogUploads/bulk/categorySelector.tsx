...
export default function CategorySelector(): React.JSX.Element {
  ...
  React.useEffect(() => {
    if (typeof window !== 'undefined' && !document.getElementById('category-selector-loader-style')) {
...
console.log('uploadimages', uploadedImages);
  ...
  const handleGenerateTemplate = async () => {
    ...
    const imageNames = (window as any).uploadedImageNames as string[] | undefined;
