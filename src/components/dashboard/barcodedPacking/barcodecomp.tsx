...
export default function Barcodecomp() {
  return (
        ...
        <Box flex={1}>
          ...
          <Stack spacing={2} sx={{ mb: 3 }}>
            <Stack direction="row" spacing={1} alignItems="center">
              <img src="https://images.meeshosupplyassets.com/fulfillment/barcoded-packaging/red_round_alert.svg" alt="!" width={20} height={20} />
              <Typography>
            ...
            <Stack direction="row" spacing={1} alignItems="center">
              <img src="https://images.meeshosupplyassets.com/fulfillment/barcoded-packaging/mobile_scan.svg" alt="phone" width={20} height={20} />
              <Typography>
            ...
            <Stack direction="row" spacing={1} alignItems="center">
              <img src="https://images.meeshosupplyassets.com/fulfillment/barcoded-packaging/scanning_gun.svg" alt="usb" width={20} height={20} />
              <Typography>
