        ...
        >
         ...
         picture-in-picture; web-share"  ></iframe>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 , border: '1px solid #ccc', p: 2, borderRadius: 2, mt: 2 }}>
            <img src="https://images.meeshosupplyassets.com/fulfillment/scanning_device.svg" alt="Scanner" width={30} />
            <Typography fontSize={14}>
      ...
      <DialogContent dividers>
        ...
        <Box display="flex" gap={2} flexWrap="wrap">
          <Box display="flex" alignItems="center" gap={2} sx={{ maxWidth: 260 }}>
            ...
            >
             <img src="https://images.meeshosupplyassets.com/fulfillment/bp_relink_step_one_dt.svg" alt="Packet Icon" width='60px' />
            </Box>
            <Typography>
          ...
          <Box display="flex" alignItems="center" gap={2} sx={{ maxWidth: 260 }}>
            ...
            >
              <img src="https://images.meeshosupplyassets.com/fulfillment/bp_relink_step_two_dt.svg" alt="Packet Icon" width='60px' />
            </Box>
            <Typography>
