		...
		<>
			<Box sx={{ py: 6, px: 2, maxWidth: "1200px", mx: "auto", backgroundColor: "#ffff", mr: -3, ml: -3, mt: 2 }}>
				...
				>
					...
					<Box sx={{ display: "flex", alignItems: "center", gap: 2, flex: 1 }}>
						<Box
							component="img"
							src="https://images.meeshosupplyassets.com/fulfillment/barcoded-packaging/scanning_gun.svg"
							alt="USB QR Scan"
					...
					<Box sx={{ display: "flex", alignItems: "center", gap: 2, flex: 1 }}>
						<Box
							component="img"
							src="https://images.meeshosupplyassets.com/fulfillment/barcoded-packaging/mobile_scan.svg"
							alt="Mobile QR Scan"
							sx={{ width: 40, height: 40 }}
						/>
						<Typography sx={{ fontSize: 14 }}>
			...
			>
				...
				<Box sx={{ display: "flex", alignItems: "center", gap: 2, flex: 1, ml: 10 }}>
					<Box
						component="img"
						src="https://images.meeshosupplyassets.com/fulfillment/barcoded-packaging/tp_package.svg"
						alt="USB QR Scan"
						sx={{ width: 40, height: 40 }}
					/>
					<Typography sx={{ fontSize: 14 }}>
				...
				<Box sx={{ display: "flex", alignItems: "center", gap: 2, flex: 1, mr: 10 }}>
					<Box
						component="img"
						src="https://images.meeshosupplyassets.com/fulfillment/barcoded-packaging/non_tp_package.svg"
						alt="Mobile QR Scan"
						sx={{ width: 40, height: 40 }}
					/>
					<Typography sx={{ fontSize: 14 }}>
