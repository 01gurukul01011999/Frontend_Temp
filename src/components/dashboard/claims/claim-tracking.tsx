...
function ClaimTracking() :React.JSX.Element {
  ...
  const [dispatchEndDate, setDispatchEndDate] = useState<Date | null>(null);
                   ...
                   >
                     <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                       <TextField
                         ...
                         value={dispatchStartDate ? dayjs(dispatchStartDate).format('YYYY-MM-DD') : ''}
                         onChange={e => setDispatchStartDate(e.target.value ? dayjs(e.target.value).toDate() : null)}
                       />
                       <TextField
                         type="date"
                         size="small"
                         label="End Date"
                         InputLabelProps={{ shrink: true }}
                         value={dispatchEndDate ? dayjs(dispatchEndDate).format('YYYY-MM-DD') : ''}
                         onChange={e => setDispatchEndDate(e.target.value ? dayjs(e.target.value).toDate() : null)}
                       />
                   ...
                   >
                     <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                       <TextField
                         ...
                         label="Start Date"
                         InputLabelProps={{ shrink: true }}
                         value={orderStartDate ? dayjs(orderStartDate).format('YYYY-MM-DD') : ''}
                         onChange={e => setOrderStartDate(e.target.value ? dayjs(e.target.value).toDate() : null)}
                       />
                       <TextField
                         type="date"
                         size="small"
                         label="End Date"
                         InputLabelProps={{ shrink: true }}
                         value={orderEndDate ? dayjs(orderEndDate).format('YYYY-MM-DD') : ''}
                         onChange={e => setOrderEndDate(e.target.value ? dayjs(e.target.value).toDate() : null)}
                       />
                       <Box sx={{ display: 'flex', gap: 1, mt: 1 }}>
